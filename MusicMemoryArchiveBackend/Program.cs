...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1", new()
    {
        Contact = new()
        {
            Email = "monitha.davuluri.606@csun.edu",
            Name = "Monitha D",
...
builder.Services.AddDbContext<MusicMemoryArchiveContext>(optionsAction: OptionsBuilder =>
OptionsBuilder.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection")));

builder.Services.AddIdentity<UserClass, IdentityRole>()
    .AddEntityFrameworkStores<MusicMemoryArchiveContext>();
