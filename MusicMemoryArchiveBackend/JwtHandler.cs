...
namespace Aspapi;
    ...
    public JwtHandler(IConfiguration configuration, UserManager<UserClass> userManager)
    {
        _configuration = configuration;
        _userManager = userManager;
    }

    public async Task<JwtSecurityToken> GetTokenAsync(UserClass user) =>
        new(
    ...
    private async Task<List<Claim>> GetClaimsAsync(UserClass user)
    {
